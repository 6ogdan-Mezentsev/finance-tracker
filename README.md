...
Клиент взаимодействует с одним backend-приложением через REST API. Внутри приложения запросы обрабатываются отдельными сервисами: User Service, Transaction Service и Report Service.
...
| 500 | Internal Server Error | Непредвиденная ошибка сервера                        | чц  |
